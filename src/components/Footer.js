                    ...
                    <div className={`flex space-x-8 ${shouldAnimateIcons ? 'fade-in-footer' : ''}`}>
                        {socialLinks.map((social) => (
                            <a
                                ...
                                className={`w-10 h-10 rounded-full flex items-center justify-center transition-[transform,background-color,color] duration-200 will-change-transform hover:scale-125 ${hoverBg[social.name]} text-gray-600 hover:text-white`}
